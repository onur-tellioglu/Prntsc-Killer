...
\```
git clone https://github.com/[onur-tellioglu]/prntscr-killer.git
\```
...
For suggestions, feedback, or inquiries, please open an issue, make a pull request, or contact the developer directly at [a@a.today](mailto:a@a.today). All contributions are welcome! 😊
